...
if (osW_Tool::getInstance()->getDoAction()=='doit') {
	...
	if ((isset($_POST['codes_chars_lower']))&&($_POST['codes_chars_lower']=='2')) {
		$chars=array_merge($chars, ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z']);
	}
	...
	if ((isset($_POST['codes_chars_upper']))&&($_POST['codes_chars_upper']=='2')) {
		$chars=array_merge($chars, ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z']);
	}
	...
	if ((isset($_POST['codes_numbers']))&&($_POST['codes_numbers']=='2')) {
		$chars=array_merge($chars, ['2', '3', '4', '5', '6', '7', '8', '9']);
	}
	...
	<form id="codes_start" method="post" action="index.php?session=<?php echo osW_Tool_Session::getInstance()->getId() ?>&action=start">
		...
		<div class="form-group<?php if (isset($error['codes_prefix'])): ?> has-error<?php endif ?>">
			...
			<div>
				...
				<?php if (isset($error['codes_prefix'])): ?>
					<span class="help-block"><?php echo $error['codes_prefix'] ?></span><?php endif ?>
			</div>
		</div>
		...
		<div class="form-group<?php if (isset($error['codes_suffix'])): ?> has-error<?php endif ?>">
			...
			<div>
				...
				<?php if (isset($error['codes_suffix'])): ?>
					<span class="help-block"><?php echo $error['codes_suffix'] ?></span><?php endif ?>
			</div>
		</div>
		...
		<div class="form-group<?php if (isset($error['codes_length'])): ?> has-error<?php endif ?>">
			...
			<div>
				...
				<?php if (isset($error['codes_length'])): ?>
					<span class="help-block"><?php echo $error['codes_length'] ?></span><?php endif ?>
			</div>
		</div>
		...
		<div class="form-group<?php if (isset($error['codes_codes_count'])): ?> has-error<?php endif ?>">
			...
			<div>
				...
				<?php if (isset($error['codes_codes_count'])): ?>
					<span class="help-block"><?php echo $error['codes_codes_count'] ?></span><?php endif ?>
			</div>
		</div>
		...
		<div class="form-group<?php if (isset($error['codes_chars_lower'])): ?> has-error<?php endif ?>">
			...
			<div>
				...
				<?php if (isset($error['codes_chars_lower'])): ?>
					<span class="help-block"><?php echo $error['codes_chars_lower'] ?></span><?php endif ?>
			</div>
		</div>
		...
		<div class="form-group<?php if (isset($error['codes_chars_upper'])): ?> has-error<?php endif ?>">
			...
			<div>
				...
				<?php if (isset($error['codes_chars_upper'])): ?>
					<span class="help-block"><?php echo $error['codes_chars_upper'] ?></span><?php endif ?>
			</div>
		</div>
		...
		<div class="form-group<?php if (isset($error['codes_numbers'])): ?> has-error<?php endif ?>">
			...
			<div>
				...
				<?php if (isset($error['codes_numbers'])): ?>
					<span class="help-block"><?php echo $error['codes_numbers'] ?></span><?php endif ?>
			</div>
		</div>
