...
define('package', 'tools.projectverify');
...
$navigation['settings']['links'][]=['links'=>[], 'action'=>'settings', 'title'=>'Settings', 'icon'=>'gear'];
...
$actions=['start', 'settings', 'changelog', 'about'];
...
$file=root_path.'oswtools/resources/settings/'.serverlist.'-'.package.'-'.release.'.json';
if (file_exists($file)) {
...
$global_css[]='../resources/css/bootstrap-select.min.css';
$global_js[]='../resources/js/jquery.dataTables.min.js';
$global_js[]='../resources/js/dataTables.bootstrap.min.js';
$global_js[]='../resources/js/bootstrap-select.min.js';
$global_js[]='../resources/js/oswtools.projectverify.js';
