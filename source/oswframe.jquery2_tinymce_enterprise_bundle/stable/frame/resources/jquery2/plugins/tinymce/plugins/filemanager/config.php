<?php
	...
	$mcFileManagerConfig['filesystem.rootpath'] = realpath('../../../../../../../../').'/data'; // absolute or relative from this script path.
	if (isset($_SESSION['tinymce_plugin_options']['filemanager'])) {
		foreach ($_SESSION['tinymce_plugin_options']['filemanager'] as $key => $value) {
			$mcFileManagerConfig[$key]=$value;
		}
	}
	$mcFileManagerConfig['authenticator'] = "osWSessionAuthenticator";
