<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = realpath('../../../../../../../../').'/data'; // absolute or relative from this script path.
	if (isset($_SESSION['tinymce_plugin_options']['imagemanager'])) {
		foreach ($_SESSION['tinymce_plugin_options']['imagemanager'] as $key => $value) {
			$mcImageManagerConfig[$key]=$value;
		}
	}
	$mcImageManagerConfig['authenticator'] = "osWSessionAuthenticator";
