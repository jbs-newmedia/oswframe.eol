...
<div class="container">
	...
	<ul class="nav nav-tabs">
		<?php foreach ($data as $key=>$value): ?>
			<li<?php if ($type==$key): ?> class="active"<?php endif ?>>
				<a href="index.php?session=<?php echo osW_Tool_Session::getInstance()->getId() ?>&action=<?php echo osW_Tool::getInstance()->getAction() ?>&type=<?php echo $key ?>"><?php echo $value ?></a>
			</li>
		<?php endforeach ?>
	</ul>
