...
$navigation['settings']['links'][]=['links'=>[], 'action'=>'protecttools', 'title'=>'Protect Tools', 'icon'=>'sign-in'];
...
$actions=['start', 'protecttools', 'changelog', 'about'];
...
$global_js[]='../resources/js/oswtools.main.js';

echo osW_Tool_Template::getInstance()->outputB3Header($navigation, $global_css, $global_js);
