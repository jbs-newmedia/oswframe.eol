...
if (file_exists(dirname(__FILE__) . '/my_' . basename(__FILE__))) {
    ...
    $premod=0;
    $file_chmod=$premod.intval($file_chmod);
    $dir_chmod=$premod.intval($dir_chmod);
}
} else {
...
if ($_SERVER['SERVER_PORT']==80) {
	$upload_file='http://'.$_SERVER['HTTP_HOST'].':80/frame/resources/tfu/tfu_upload.php';
}

if ($_SERVER['SERVER_PORT']==443) {
	$upload_file='https://'.$_SERVER['HTTP_HOST'].':443/frame/resources/tfu/tfu_upload.php';
}
