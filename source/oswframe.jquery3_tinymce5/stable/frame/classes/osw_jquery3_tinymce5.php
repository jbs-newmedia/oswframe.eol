 ...
 *
 */
class osW_JQuery3_TinyMCE5 extends osW_Object {
	...
	public function draw($name, $insert_value='', $options=[], $tinymce_options_in=[], $tinymce_plugin_options_in=[]) {
		...
		$tinymce_options['script_url']='/frame/resources/jquery3/plugins/tinymce5/tinymce.min.js';
