...
<td class="table_ddm_col table_ddm_col_data ddm_element_<?php echo $this->getListElementValue($ddm_group, $element, 'id')?>">
	...
	<?php if($this->getListElementOption($ddm_group, $element, 'order')==true):?>
		<?php if($this->getParameter($ddm_group, 'ddm_order_last')==$this->getGroupOption($ddm_group, 'alias', 'database').'.'.$element.'__asc'):?>
			<?php echo h()->_outputString($this->getGroupMessage($ddm_group, 'form_title_sort_spacer'))?>
		...
		<?php endif?>
		<?php if($this->getParameter($ddm_group, 'ddm_order_last')==$this->getGroupOption($ddm_group, 'alias', 'database').'.'.$element.'__desc'):?>
			<?php echo h()->_outputString($this->getGroupMessage($ddm_group, 'form_title_sort_spacer'))?>
