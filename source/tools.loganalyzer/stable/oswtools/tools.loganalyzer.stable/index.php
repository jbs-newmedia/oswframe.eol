...
define('package', 'tools.loganalyzer');
...
echo osW_Tool_Template::getInstance()->outputB3Header($navigation, $global_css, $global_js, $script, true);

include abs_path.package.'.'.release.'/'.osW_Tool::getInstance()->getAction().'.inc.php';

echo osW_Tool_Template::getInstance()->outputB3Footer(true);
