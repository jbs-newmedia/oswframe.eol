		...
		<div class="col-xs-12 col-lg-2">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<?php if (isset($data['dates'])): ?><?php foreach ($data['dates'] as $datekey=>$datevalue): ?><?php if ($datekey==$data['date']): ?><?php echo date($date, mktime(12, 0, 0, substr($datekey, 4, 2), substr($datekey, 6, 2), substr($datekey, 0, 4))) ?>
						<br/>
					<?php else: ?>
						<a href="?dir=<?php echo $data['dir'] ?>&amp;date=<?php echo $datevalue ?>"><?php echo date($date, mktime(12, 0, 0, substr($datekey, 4, 2), substr($datekey, 6, 2), substr($datekey, 0, 4))) ?></a>
						<br/>
