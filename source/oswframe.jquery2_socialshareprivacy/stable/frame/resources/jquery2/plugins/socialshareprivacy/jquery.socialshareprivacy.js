    ...
    $.fn.socialSharePrivacy = function (settings) {
        var defaults = {
            'services' : {
                'facebook' : {
                    'status'            : 'on',
                    'dummy_img'         : '/frame/resources/jquery2/plugins/socialshareprivacy/socialshareprivacy/images/dummy_facebook.png',
                    'perma_option'      : 'on',
                    'referrer_track'    : '',
                    'action'            : 'recommend',
                    'layout'            : 'button_count',
                    'sharer'            : {
                        'status'        : 'off',
                        'dummy_img'     : '/frame/resources/jquery2/plugins/socialshareprivacy/socialshareprivacy/images/dummy_facebook_share_de.png',
                        'img'           : '/frame/resources/jquery2/plugins/socialshareprivacy/socialshareprivacy/images/dummy_facebook_share_active_de.png'
                    }
                },
                'twitter' : {
                    'status'            : 'on',
                    'dummy_img'         : '/frame/resources/jquery2/plugins/socialshareprivacy/socialshareprivacy/images/dummy_twitter.png',
                    'perma_option'      : 'on',
                    'referrer_track'    : '',
                ...
                'gplus' : {
                    'status'            : 'on',
                    'dummy_img'         : '/frame/resources/jquery2/plugins/socialshareprivacy/socialshareprivacy/images/dummy_gplus.png',
                    'perma_option'      : 'on',
                    'referrer_track'    : '',
                    'size'              : 'medium'
                }
            ...
            'cookie_expires'    : '365',
            'css_path'          : '__SCRIPTOPTIMIZER_PATH__/frame/resources/jquery2/plugins/socialshareprivacy/socialshareprivacy/socialshareprivacy.css',
            'uri'               : getURI,
            'language'          : 'de',
            'lang_path'         : '/frame/resources/jquery2/plugins/socialshareprivacy/socialshareprivacy/lang/',
            'skin'              : 'light',
