...
$default_options['options']['text_file_view']=$this->getGroupMessage($ddm_group, 'text_file_view');
$default_options['options']['text_file_delete']=$this->getGroupMessage($ddm_group, 'text_file_delete');
