...
<tr class="table_ddm_row table_ddm_row_data <?php echo osW_Template::getInstance()->getColorClass('table_ddm_rows', ['table_ddm_row_cella', 'table_ddm_row_cellb']) ?> <?php if (osW_Form::getInstance()->getFormError($element)===true): ?>table_ddm_row_error<?php endif ?> ddm_element_<?php echo $this->getSearchElementValue($ddm_group, $element, 'id') ?> ">
	...
	<td class="table_ddm_col table_ddm_col_data table_ddm_col_form">
		<ul class="table_ddm_list table_ddm_list_horizontal">
			<li><?php echo osW_Form::getInstance()->drawRadioField($element, '%', $this->getSearchElementStorage($ddm_group, $element), []) ?><?php echo h()->_outputString($values['options']['text_all']) ?></li>
			<li><?php echo osW_Form::getInstance()->drawRadioField($element, '1', $this->getSearchElementStorage($ddm_group, $element), []) ?><?php echo h()->_outputString($values['options']['text_yes']) ?></li>
			<li><?php echo osW_Form::getInstance()->drawRadioField($element, '0', $this->getSearchElementStorage($ddm_group, $element), []) ?><?php echo h()->_outputString($values['options']['text_no']) ?></li>
		</ul>
	</td>
</tr>