...
?>
	...
	<tr class="table_ddm_row <?php if (osW_Form::getInstance()->getFormError($element.'_double')===true): ?>table_ddm_row_error<?php endif ?> table_ddm_row_data table_ddm_row_data_<?php echo $this->getDeleteElementValue($ddm_group, $element, 'id_double') ?> <?php echo osW_Template::getInstance()->getColorClass('table_ddm_rows', ['table_ddm_row_data_cella', 'table_ddm_row_data_cellb']) ?>">
		<td <?php if ($this->getDeleteElementOption($ddm_group, $element, 'notice')!=''): ?>rowspan="2"<?php endif ?> class="table_ddm_col table_ddm_col_data table_ddm_col_title"><?php echo h()->outputString($this->getDeleteElementOption($ddm_group, $element, 'title_double')) ?><?php if ($this->getDeleteElementOption($ddm_group, $element, 'required')===true): ?><?php echo $this->getGroupMessage($ddm_group, 'form_title_required_icon') ?><?php endif ?><?php echo $this->getGroupMessage($ddm_group, 'form_title_closer') ?></td>
		<td class="table_ddm_col table_ddm_col_data table_ddm_col_form">
			********
		</td>
	</tr>
