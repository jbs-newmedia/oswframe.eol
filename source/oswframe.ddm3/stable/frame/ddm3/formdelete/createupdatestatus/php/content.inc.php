...
if ((osW_Settings::getInstance()->getAction()=='delete')||(osW_Settings::getInstance()->getAction()=='dodelete')) {
	...
	$Qselect->bindRaw(':elements:', implode(', ', [$this->getGroupOption($ddm_group, 'alias', 'database').'.'.$this->getDeleteElementOption($ddm_group, $element, 'prefix').'create_time', $this->getGroupOption($ddm_group, 'alias', 'database').'.'.$this->getDeleteElementOption($ddm_group, $element, 'prefix').'create_user_id', $this->getGroupOption($ddm_group, 'alias', 'database').'.'.$this->getDeleteElementOption($ddm_group, $element, 'prefix').'update_time', $this->getGroupOption($ddm_group, 'alias', 'database').'.'.$this->getDeleteElementOption($ddm_group, $element, 'prefix').'update_user_id']));
