...
<?php if ($this->getDeleteElementValue($ddm_group, $element, 'title')==''): ?>
	<tr class="table_ddm_row table_ddm_row_data <?php echo osW_Template::getInstance()->getColorClass('table_ddm_rows', ['table_ddm_row_cella', 'table_ddm_row_cellb']) ?> <?php if (osW_Form::getInstance()->getFormError($element)===true): ?>table_ddm_row_error<?php endif ?> ddm_element_<?php echo $this->getDeleteElementValue($ddm_group, $element, 'id') ?> ">
		<td colspan="2" <?php if ($this->getDeleteElementOption($ddm_group, $element, 'notice')!=''): ?>rowspan="2"<?php endif ?> class="table_ddm_col table_ddm_col_data table_ddm_col_label">
			<?php if ($this->getDeleteElementOption($ddm_group, $element, 'ishtml')===true): ?><?php echo $this->getDeleteElementOption($ddm_group, $element, 'label') ?><?php else: ?><?php echo h()->outputString($this->getDeleteElementOption($ddm_group, $element, 'label')) ?><?php endif ?>
		</td>
	</tr>
