...
if (osW_Settings::getInstance()->getAction()=='doadd') {
	...
	if ((isset($_FILES[$element]))&&($_FILES[$element]['error']==0)) {
		...
		if ($this->getAddElementOption($ddm_group, $element, 'store_name')===true) {
			...
			osW_DDM3::getInstance()->addDataElement($ddm_group, $element.'_name', ['module'=>'hidden', 'name'=>$this->getAddElementValue($ddm_group, $element, 'name').'_name']);
		}
		...
		if ($this->getAddElementOption($ddm_group, $element, 'store_type')===true) {
			...
			osW_DDM3::getInstance()->addDataElement($ddm_group, $element.'_type', ['module'=>'hidden', 'name'=>$this->getAddElementValue($ddm_group, $element, 'name').'_type']);
		}
		...
		if ($this->getAddElementOption($ddm_group, $element, 'store_size')===true) {
			...
			osW_DDM3::getInstance()->addDataElement($ddm_group, $element.'_size', ['module'=>'hidden', 'name'=>$this->getAddElementValue($ddm_group, $element, 'name').'_size']);
		}
		...
		if ($this->getAddElementOption($ddm_group, $element, 'store_md5')===true) {
			...
			osW_DDM3::getInstance()->addDataElement($ddm_group, $element.'_md5', ['module'=>'hidden', 'name'=>$this->getAddElementValue($ddm_group, $element, 'name').'_md5']);
		}
