...
?>
	...
	<tr class="table_ddm_row table_ddm_row_data <?php echo osW_Template::getInstance()->getColorClass('table_ddm_rows', ['table_ddm_row_cella', 'table_ddm_row_cellb']) ?> <?php if (osW_Form::getInstance()->getFormError($element)===true): ?>table_ddm_row_error<?php endif ?> ddm_element_<?php echo $this->getEditElementValue($ddm_group, $element, 'id') ?> ">
		...
		<td class="table_ddm_col table_ddm_col_data table_ddm_col_form">
			<?php if ($this->getEditElementOption($ddm_group, $element, 'read_only')===true): ?><?php echo osW_Form::getInstance()->drawHiddenField($element, $this->getEditElementStorage($ddm_group, $element), []) ?><?php if ($this->getEditElementOption($ddm_group, $element, 'blank_value')===true): ?><?php $data=[''=>'']+$this->getEditElementOption($ddm_group, $element, 'data'); ?><?php else: ?><?php $data=$this->getEditElementOption($ddm_group, $element, 'data'); ?><?php endif ?><?php if (isset($data[$this->getEditElementStorage($ddm_group, $element)])): ?><?php echo h()->_outputString($data[$this->getEditElementStorage($ddm_group, $element)]) ?><?php else: ?>
				&nbsp;
			<?php endif ?><?php else: ?><?php if ($this->getEditElementOption($ddm_group, $element, 'blank_value')===true): ?><?php echo osW_Form::getInstance()->drawSelectField($element, [''=>'']+$this->getEditElementOption($ddm_group, $element, 'data'), $this->getEditElementStorage($ddm_group, $element), []) ?><?php else: ?><?php echo osW_Form::getInstance()->drawSelectField($element, $this->getEditElementOption($ddm_group, $element, 'data'), $this->getEditElementStorage($ddm_group, $element), []) ?><?php endif ?><?php endif ?>
		</td>
	</tr>
