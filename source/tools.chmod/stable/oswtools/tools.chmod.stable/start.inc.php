...
$chmods_file=['0664'=>'0664', '0644'=>'0644', '0660'=>'0660', '0640'=>'0640'];

$chmods_dir=['0775'=>'0775', '0755'=>'0755', '0770'=>'0770', '0750'=>'0750'];
	...
	<form id="chmod_start" method="post" action="index.php?session=<?php echo osW_Tool_Session::getInstance()->getId() ?>&action=start">
		...
		<div class="form-group<?php if (isset($error['chmod_directory'])): ?> has-error<?php endif ?>">
			...
			<div>
				...
				<?php if (isset($error['chmod_directory'])): ?>
					<span class="help-block"><?php echo $error['chmod_directory'] ?></span><?php endif ?>
			</div>
		</div>
		...
		<div class="form-group<?php if (isset($error['chmod_files'])): ?> has-error<?php endif ?>">
			...
			<div>
				...
				<?php if (isset($error['chmod_files'])): ?>
					<span class="help-block"><?php echo $error['chmod_files'] ?></span><?php endif ?>
			</div>
		</div>
		...
		<div class="form-group<?php if (isset($error['chmod_dirs'])): ?> has-error<?php endif ?>">
			...
			<div>
				...
				<?php if (isset($error['chmod_dirs'])): ?>
					<span class="help-block"><?php echo $error['chmod_dirs'] ?></span><?php endif ?>
			</div>
		</div>
