...
if (strlen($this->getDoEditElementStorage($ddm_group, $element))>0) {
	if (h()->_verifyURLIDNAPattern($this->getDoEditElementStorage($ddm_group, $element))!==true) {
		if (h()->_verifyURLIDNAPattern('http://'.$this->getDoEditElementStorage($ddm_group, $element))!==true) {
