...
if (strlen($this->getDoAddElementStorage($ddm_group, $element))>0) {
	if (h()->_verifyURLIDNAPattern($this->getDoAddElementStorage($ddm_group, $element))!==true){
		if (h()->_verifyURLIDNAPattern('http://'.$this->getDoAddElementStorage($ddm_group, $element))!==true){
