...
<div class="form-group<?php if(osW_Form::getInstance()->getFormError($element)):?> has-error<?php endif?> ddm_element_<?php echo $this->getSearchElementValue($ddm_group, $element, 'id')?>">
	...
	<?php if($this->getSearchElementOption($ddm_group, $element, 'blank_value')===true):?>
		<?php echo osW_Form::getInstance()->drawSelectField($element, array('%'=>$values['options']['text_all'])+array(''=>'')+$this->getSearchElementOption($ddm_group, $element, 'data'), $this->getSearchElementStorage($ddm_group, $element), array('input_class'=>'form-control selectpicker'))?>
	<?php else:?>
		<?php echo osW_Form::getInstance()->drawSelectField($element, array('%'=>$values['options']['text_all'])+$this->getSearchElementOption($ddm_group, $element, 'data'), $this->getSearchElementStorage($ddm_group, $element), array('input_class'=>'form-control selectpicker'))?>
	<?php endif?>
