...
<tr class="table_ddm_row table_ddm_row_data <?php echo osW_Template::getInstance()->getColorClass('table_ddm_rows', array('table_ddm_row_cella', 'table_ddm_row_cellb'))?> <?php if(osW_Form::getInstance()->getFormError($element)===true):?>table_ddm_row_error<?php endif?> ddm_element_<?php echo $this->getSearchElementValue($ddm_group, $element, 'id')?> ">
	...
	<td class="table_ddm_col table_ddm_col_data table_ddm_col_form">
		...
		<?php $date_format=str_replace('%osw_tmp_ddm3_%d', osW_Form::getInstance()->drawSelectField($element.'_day___0', $data['day'], substr($this->getSearchElementStorage($ddm_group, $element.'___0'), 6, 2), array()), $date_format)?>
		<?php $date_format=str_replace('%osw_tmp_ddm3_%m', osW_Form::getInstance()->drawSelectField($element.'_month___0', $data['month'], substr($this->getSearchElementStorage($ddm_group, $element.'___0'), 4, 2), array()), $date_format)?>
		<?php $date_format=str_replace('%osw_tmp_ddm3_%Y', osW_Form::getInstance()->drawSelectField($element.'_year___0', $data['year'], substr($this->getSearchElementStorage($ddm_group, $element.'___0'), 0, 4), array()), $date_format)?>
		<?php $date_format=str_replace('%osw_tmp_ddm3_%y', osW_Form::getInstance()->drawSelectField($element.'_year___0', $data['year'], substr($this->getSearchElementStorage($ddm_group, $element.'___0'), 0, 4), array()), $date_format)?>
		...
		<?php $date_format=$this->getSearchElementOption($ddm_group, $element, 'date_format')?>
		<?php $date_format=str_replace('%', '%osw_tmp_ddm3_%', $date_format)?>
		<?php $date_format=str_replace('%osw_tmp_ddm3_%d', osW_Form::getInstance()->drawSelectField($element.'_day___1', $data['day'], substr($this->getSearchElementStorage($ddm_group, $element.'___1'), 6, 2), array()), $date_format)?>
		<?php $date_format=str_replace('%osw_tmp_ddm3_%m', osW_Form::getInstance()->drawSelectField($element.'_month___1', $data['month'], substr($this->getSearchElementStorage($ddm_group, $element.'___1'), 4, 2), array()), $date_format)?>
		<?php $date_format=str_replace('%osw_tmp_ddm3_%Y', osW_Form::getInstance()->drawSelectField($element.'_year___1', $data['year'], substr($this->getSearchElementStorage($ddm_group, $element.'___1'), 0, 4), array()), $date_format)?>
		<?php $date_format=str_replace('%osw_tmp_ddm3_%y', osW_Form::getInstance()->drawSelectField($element.'_year___1', $data['year'], substr($this->getSearchElementStorage($ddm_group, $element.'___1'), 0, 4), array()), $date_format)?>
		<?php echo $date_format;?>
	</td>
</tr>
