...
<a target="_blank" href="<?php echo $this->getDoAddElementStorage($ddm_group, $element.$this->getAddElementOption($ddm_group, $element, 'temp_suffix'))?>"><?php echo h()->_outputString($this->getAddElementOption($ddm_group, $element, 'text_file_view'))?></a><br/>
<?php osW_Form::getInstance()->drawHiddenField($element.$this->getAddElementOption($ddm_group, $element, 'temp_suffix'), $this->getDoAddElementStorage($ddm_group, $element.$this->getAddElementOption($ddm_group, $element, 'temp_suffix')))?>
<?php osW_Form::getInstance()->drawHiddenField($element, $this->getDoAddElementStorage($ddm_group, $element))?>
<?php endif?>

<?php echo osW_Form::getInstance()->drawFileField($element, $this->getAddElementStorage($ddm_group, $element), array())?>

<?php if($this->getDoAddElementStorage($ddm_group, $element.$this->getAddElementOption($ddm_group, $element, 'temp_suffix'))!=''):?>
<br/><?php echo osW_Form::getInstance()->drawCheckboxField($element.$this->getAddElementOption($ddm_group, $element, 'temp_suffix').$this->getAddElementOption($ddm_group, $element, 'delete_suffix'), 1, 0, array())?> <?php echo h()->_outputString($this->getAddElementOption($ddm_group, $element, 'text_file_delete'))?><br/>
<?php endif?>
	</td>
</tr>
