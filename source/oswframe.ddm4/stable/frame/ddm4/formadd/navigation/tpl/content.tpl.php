...
$links=$this->getAddElementOption($ddm_group, $element, 'data');
$links_anz=0;
if(is_array($links)) {
...
<?php if($links_anz>0):?>
<tr class="table_ddm_row table_ddm_row_navigation ddm_element_<?php echo $this->getAddElementValue($ddm_group, $element, 'id')?>">
