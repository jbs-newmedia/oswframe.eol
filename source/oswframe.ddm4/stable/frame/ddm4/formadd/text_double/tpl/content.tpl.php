...
<tr class="table_ddm_row <?php if(osW_Form::getInstance()->getFormError($element.'_double')===true):?>table_ddm_row_error<?php endif?> table_ddm_row_data table_ddm_row_data_<?php echo $this->getAddElementValue($ddm_group, $element, 'id_double')?> <?php echo osW_Template::getInstance()->getColorClass('table_ddm_rows', array('table_ddm_row_data_cella', 'table_ddm_row_data_cellb'))?>">
