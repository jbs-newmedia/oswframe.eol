...
if (($this->getFilterErrorElementStorage($ddm_group, $element)!==true)&&(strlen($file_name)>0)) {
	...
	if ($getimagesize!==false) {
		...
		if (($this->getFilterErrorElementStorage($ddm_group, $element)!==true)&&($this->getAddElementValidation($ddm_group, $element, 'width_min')!='')) {
			if ($getimagesize[0]<$this->getAddElementValidation($ddm_group, $element, 'width_min')) {
				osW_Form::getInstance()->addFormError($element);
		...
		if (($this->getFilterErrorElementStorage($ddm_group, $element)!==true)&&($this->getAddElementValidation($ddm_group, $element, 'width_max')!='')) {
			if ($getimagesize[0]>$this->getAddElementValidation($ddm_group, $element, 'width_max')) {
				osW_Form::getInstance()->addFormError($element);
		...
		if (($this->getFilterErrorElementStorage($ddm_group, $element)!==true)&&($this->getAddElementValidation($ddm_group, $element, 'height_min')!='')) {
			if ($getimagesize[1]<$this->getAddElementValidation($ddm_group, $element, 'height_min')) {
				osW_Form::getInstance()->addFormError($element);
		...
		if (($this->getFilterErrorElementStorage($ddm_group, $element)!==true)&&($this->getAddElementValidation($ddm_group, $element, 'height_max')!='')) {
			if ($getimagesize[1]>$this->getAddElementValidation($ddm_group, $element, 'height_max')) {
				osW_Form::getInstance()->addFormError($element);
