...
if (strlen($this->getDoSendElementStorage($ddm_group, $element))>0) {
	if (h()->_verifyURLIDNAPattern($this->getDoSendElementStorage($ddm_group, $element))!==true){
		if (h()->_verifyURLIDNAPattern('http://'.$this->getDoSendElementStorage($ddm_group, $element))!==true){
