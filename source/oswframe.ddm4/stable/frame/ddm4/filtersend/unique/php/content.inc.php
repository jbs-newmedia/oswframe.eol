...
if (strlen($this->getDoSendElementStorage($ddm_group, $element))>0) {
	...
	$QcheckData->bindRaw(':formdata_name:', $this->getSendElementValue($ddm_group, $element, 'name'));
	$QcheckData->bindValue(':value:', $this->getDoSendElementStorage($ddm_group, $element));
	$QcheckData->execute();
