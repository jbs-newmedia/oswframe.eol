...
if (($this->getFilterErrorElementStorage($ddm_group, $element)!==true)&&($this->getFilterErrorElementStorage($ddm_group, $element.'_upload_error')==true)) {
	osW_Form::getInstance()->addFormError($element);
	osW_MessageStack::getInstance()->add('form', 'error', array('msg'=>h()->_setText($this->getGroupMessage($ddm_group, 'validation_image_uploaderror'), $this->getFilterElementStorage($ddm_group, $element))));
	$this->setFilterErrorElementStorage($ddm_group, $element, true);
...
if (($this->getFilterErrorElementStorage($ddm_group, $element)!==true)&&(strlen($file_name)>0)) {
	...
	if ($getimagesize!==false) {
		...
		if (($this->getFilterErrorElementStorage($ddm_group, $element)!==true)&&($this->getSendElementValidation($ddm_group, $element, 'width_min')!='')) {
			if ($getimagesize[0]<$this->getSendElementValidation($ddm_group, $element, 'width_min')) {
				osW_Form::getInstance()->addFormError($element);
				osW_MessageStack::getInstance()->add('form', 'error', array('msg'=>h()->_setText($this->getGroupMessage($ddm_group, 'validation_imagewidth_tosmall'), $this->getFilterElementStorage($ddm_group, $element))));
				$this->setFilterErrorElementStorage($ddm_group, $element, true);
			}
		}

		if (($this->getFilterErrorElementStorage($ddm_group, $element)!==true)&&($this->getSendElementValidation($ddm_group, $element, 'width_max')!='')) {
			if ($getimagesize[0]>$this->getSendElementValidation($ddm_group, $element, 'width_max')) {
				osW_Form::getInstance()->addFormError($element);
				osW_MessageStack::getInstance()->add('form', 'error', array('msg'=>h()->_setText($this->getGroupMessage($ddm_group, 'validation_imagewidth_tobig'), $this->getFilterElementStorage($ddm_group, $element))));
				$this->setFilterErrorElementStorage($ddm_group, $element, true);
			}
		}

		if (($this->getFilterErrorElementStorage($ddm_group, $element)!==true)&&($this->getSendElementValidation($ddm_group, $element, 'height_min')!='')) {
			if ($getimagesize[1]<$this->getSendElementValidation($ddm_group, $element, 'height_min')) {
				osW_Form::getInstance()->addFormError($element);
				osW_MessageStack::getInstance()->add('form', 'error', array('msg'=>h()->_setText($this->getGroupMessage($ddm_group, 'validation_imageheight_tosmall'), $this->getFilterElementStorage($ddm_group, $element))));
				$this->setFilterErrorElementStorage($ddm_group, $element, true);
			}
		}

		if (($this->getFilterErrorElementStorage($ddm_group, $element)!==true)&&($this->getSendElementValidation($ddm_group, $element, 'height_max')!='')) {
			if ($getimagesize[1]>$this->getSendElementValidation($ddm_group, $element, 'height_max')) {
				osW_Form::getInstance()->addFormError($element);
				osW_MessageStack::getInstance()->add('form', 'error', array('msg'=>h()->_setText($this->getGroupMessage($ddm_group, 'validation_imageheight_tobig'), $this->getFilterElementStorage($ddm_group, $element))));
				$this->setFilterErrorElementStorage($ddm_group, $element, true);
			}
		}
		...
		osW_Form::getInstance()->addFormError($element);
		osW_MessageStack::getInstance()->add('form', 'error', array('msg'=>h()->_setText($this->getGroupMessage($ddm_group, 'validation_image_fileerror'), $this->getFilterElementStorage($ddm_group, $element))));
		$this->setFilterErrorElementStorage($ddm_group, $element, true);
	}
}
