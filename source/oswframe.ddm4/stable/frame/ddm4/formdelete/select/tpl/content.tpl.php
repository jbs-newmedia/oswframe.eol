...
<div class="form-group<?php if(osW_Form::getInstance()->getFormError($element)):?> has-error<?php endif?> ddm_element_<?php echo $this->getDeleteElementValue($ddm_group, $element, 'id')?>">
	...
	<?php if($this->getDeleteElementOption($ddm_group, $element, 'blank_value')===true):?>
		<?php $data=array(''=>'')+$this->getDeleteElementOption($ddm_group, $element, 'data');?>
	<?php else:?>
		<?php $data=$this->getDeleteElementOption($ddm_group, $element, 'data');?>
	<?php endif?>
	<?php if(isset($data[$this->getDeleteElementStorage($ddm_group, $element)])):?>
		<div class="form-control readonly"><?php echo h()->_outputString($data[$this->getDeleteElementStorage($ddm_group, $element)])?></div>
	<?php else:?>
