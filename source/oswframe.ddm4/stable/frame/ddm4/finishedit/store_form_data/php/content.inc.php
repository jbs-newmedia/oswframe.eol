...
if ($this->getGroupOption($ddm_group, 'enable_log')===true) {
	...
	osW_DDM3_Log::getInstance()->writeValues($group, $this->getGroupOption($ddm_group, 'index', 'database'), $this->getIndexElementStorage($ddm_group));
}

osW_MessageStack::getInstance()->addSession('session', 'success', array('msg'=>$this->getGroupMessage($ddm_group, 'edit_success_title')));
