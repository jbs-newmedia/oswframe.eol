...
<a target="_blank" href="<?php echo $this->getEditElementStorage($ddm_group, $element)?>"><?php echo h()->_outputString($this->getEditElementOption($ddm_group, $element, 'text_file_view'))?></a><?php if ($this->getEditElementOption($ddm_group, $element, 'edit_enabled')):?> | <a class="fancybox fancybox.iframe" target="_blank" id="ddm_element_<?php echo $ddm_group?>_<?php echo $element?>_crop_link" href="<?php echo osW_Template::getInstance()->buildhrefLink('current', 'vistool='.osW_VIS2::getInstance()->getTool().'&vispage=vis_api&action=ddm3_popup&function=ddm3_fileimage_edit&ddm_element='.$ddm_group.'_'.$element)?>">Bearbeiten</a><?php endif?><br/>
